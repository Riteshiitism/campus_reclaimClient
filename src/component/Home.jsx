...
export default function Home() {
  ...
  useEffect(() => {
    if (localStorage.getItem("lfsuserid") !== null) {
      ...
      <div data-aos="fade-right">
        <Container fluid className="total-inspiration">
          ...
          <Row className="inspiration">
            ...
            <p>
              Colleges are the place where we come to hostel mentioning about
        ...
        <Container fluid>
          <div className="feature">
            <div>
              ...
              <div>
                <p>
                  Personal information are is something which should be taken
